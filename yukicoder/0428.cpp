...
int main(){
	bint d("1234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556575859606162636465666768697071727374757677787980818283848586878889909192939495969798991");
	int n; cin>>n;

	string s=to_string(d*n);
	int l=s.length();
	if(l==190) cout<<"0.";
	else       cout<<s.substr(0,l-190)<<".";
	cout<<s.substr(l-190,190)<<'\n';
